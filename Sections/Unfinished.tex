...
\begin{prob}{F12}{F12.3}
    \begin{enumerate}[(a)]
        \item Let $X$ be a nonempty set and $B$ a subset of the powerset of $X$. Give necessary and sufficient conditions on $B$ such that it is a basis for some topology on $X$.
        ...
        \end{enumerate}
        \item Show that the set $\prod F_i$ equiped with the topology from (i) need not be homeomorphic to the set $\prod F_i$ equiped with the topology from (ii).
    \end{enumerate}
\end{prob}
