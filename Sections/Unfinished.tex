...
A topological space $X$ is disconnected if there exist open sets $A,B$ with $A \cap B = \varnothing$ and $X = A \sqcup B$. The space $X$ is connected if it is not disconnected.
